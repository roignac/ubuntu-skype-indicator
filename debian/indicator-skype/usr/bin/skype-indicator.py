...
class skypeIndicator:
	...
	def append_notification(self, new_notification):
		...
		print "Appending notification handle=%s, type=%s" % (new_notification.handle, new_notification.notif_type)
		found = False
		...
		for notification in self.notifications:
			...
			print "Checking notif handle=%s, type=%s" % (notification.handle, notification.notif_type)
